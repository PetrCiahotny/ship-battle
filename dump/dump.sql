CREATE DATABASE IF NOT EXISTS lode DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE lode;
...
CREATE TABLE lode.uzivatele (
                             ...
                             heslo varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
                             PRIMARY KEY (id),
...
CREATE TABLE lode.bitvy (
                       ...
                       mapa1 text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
                       mapa2 text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
                       vitez int DEFAULT 0,
